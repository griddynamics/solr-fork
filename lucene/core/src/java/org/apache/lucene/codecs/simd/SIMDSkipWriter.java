 ...
 *
 */
final class SIMDSkipWriter extends MultiLevelSkipListWriter {
  ...
  public SIMDSkipWriter(int maxSkipLevels, int blockSize, int docCount, IndexOutput docOut, IndexOutput posOut, IndexOutput payOut) {
