 ...
 *
 */
final class SIMDSkipReader extends MultiLevelSkipListReader {
  ...
  public SIMDSkipReader(IndexInput skipStream, int maxSkipLevels, int blockSize, boolean hasPos, boolean hasOffsets, boolean hasPayloads) {
